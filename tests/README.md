...
3. Open `http://127.0.0.1:8767/tests/browser.html` in Chrome. Expect **19/19 passed**, including Excel marker colors and numeric dates, summary/notes highlighting, selection boundaries, Excel chat rich formatting and per-article mapping, header styling and embedded icons.
